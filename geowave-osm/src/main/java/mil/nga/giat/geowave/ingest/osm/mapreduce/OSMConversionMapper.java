package mil.nga.giat.geowave.ingest.osm.mapreduce;
...
public class OSMConversionMapper extends Mapper<Key, Value, Text, Text> {
	...
	private Index _index = IndexType.SPATIAL.createDefaultIndex();
	...
	public void map(Key row, Value data, Context context) throws IOException, InterruptedException {
    	  ...
    	  Map<Integer, Map<String, String>> roles = new HashMap<Integer, Map<String, String>>();
     	  for (Entry<Key,Value> entry2 : OSMConversionIterator.decodeRow(row,data).entrySet()){
