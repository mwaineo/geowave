...
import mil.nga.giat.geowave.ingest.osm.mapreduce.OSMConversionMapper;
import mil.nga.giat.geowave.ingest.osm.mapreduce.OSMConversionRunner;
...
public class AccTest {
    ...
    private static BasicAccumuloOperations _bao;
      ...
      public static void main(final String[] args) throws IOException, AccumuloException, AccumuloSecurityException, TableNotFoundException {
    	  ...
    	  Index defIndex = IndexType.SPATIAL.createDefaultIndex();
